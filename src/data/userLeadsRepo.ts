...
function normalizeLead(id: string, data: Record<string, unknown>): MetaLeadDoc {
    return {
        ...
        takenFromIncompleteAt: toNum(data.takenFromIncompleteAt),
        ...
        userChatLastSeenMessageAt: toNum(data.userChatLastSeenMessageAt),
        userChatSeenAt: toNum(data.userChatSeenAt),
        userUnreadMessageCount: toNum(data.userUnreadMessageCount),
